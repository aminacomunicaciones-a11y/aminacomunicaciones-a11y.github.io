...
Portada de **Amina Juegos**. Es el *sitio de usuario* de GitHub Pages: al llamarse el
...
|---|---|---|
| El icono era el globo genérico | Google coge el favicon de la raíz del dominio | `/favicon.ico` con la A de Amina |
| Ponía «GitHub Pages documentation» | Google coge el nombre del sitio del título de la portada | El `<title>` de aquí: **Amina Juegos** |
